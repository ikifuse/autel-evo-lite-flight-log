...
`v1.0.0` は公開リポジトリとしての安定版を示し、`2026.09.06.2` はアプリ内で表示・管理する実装バージョンです。
...
開発者向けのビルド、分割構成、保存の冪等性、テスト、障害復旧などの詳細は、[設計書](./01_ドローン運航記録_設計書.md)と[コードマップ](./docs/code-map.md)を参照してください。
